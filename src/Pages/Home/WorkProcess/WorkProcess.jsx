  ...
  return (
    <div className="p-8 font-sans max-w-screen-xl mx-auto">
      ...
      <p className="mb-8 text-slate-500">
        ...
        services.Navigating your healthcare journey with HealNet is seamless.
      ...
      <div className="flex justify-center items-center">
        <div className=" border-black border-l-2 border-dotted">

        </div>
        <div className="relative w-3/5 space-y-8 me-9">
